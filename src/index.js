...
var dataset, svg
var salarySizeScale, salaryXScale, salaryYScale, categoryColorScale, shareWomenXScale, enrollmentScale, enrollmentSizeScale, histXScale, histYScale
var simulation, nodes
var categoryLegend, salaryLegend
...
function drawInitial() {
  ...
  const xAxis = d3.axisBottom(salaryXScale)
    .ticks(4)
    .tickSize(height + 80)
...
function draw4() {
  ...
  const xAxis = d3.axisBottom(histXScale)
  svg.append('g')
...
const scroll = scroller.scrollerMain()
